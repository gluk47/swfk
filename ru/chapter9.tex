...
%TODO уточнить терминологию
Последняя из команд в предыдущем примере рисует аккурат целый эллипс (он же овал\footnote{На самом деле, эллипсом называют саму линию, а овалом — то, что она ограничивает.}). Чтобы рисовать овалы, есть и специальная команда, покороче: \code{create\_oval}. Так же, как и для рисования дуги, для рисования овала надо задать ограничивающий прямоугольник. Например, вот такой:
